...
$types = ['punaviinit', 'roseeviinit', 'valkoviinit', 'rommit', 'konjakit', 'viskit', 'oluet', 'siiderit', 'juomasekoitukset', 'alkoholittomat', 'lahja- ja juomatarvikkeet', 'Jälkiruokaviinit, väkevöidyt ja muut viinit', 'Brandyt, Armanjakit ja Calvadosit', 'Ginit ja maustetut viinat', 'Liköörit ja Katkerot', 'kuohuviinit & samppanjat', 'vodkat ja viinat'];
?>
