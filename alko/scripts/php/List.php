...
// Array of bottle sizes
$bottleSizes = ['0,2 l', '0,33 l', '0,5 l', '0,7 l', '0,75 l', '1 l', '1,5 l', '2 l', '3 l'];

// Array of product types
$types = [
    'punaviinit', 'roseeviinit', 'valkoviinit', 'rommit', 'konjakit', 'viskit', 'oluet', 'siiderit', 'juomasekoitukset',
    'alkoholittomat', 'lahja- ja juomatarvikkeet', 'Jälkiruokaviinit, väkevöidyt ja muut viinit', 'Brandyt, Armanjakit ja Calvadosit',
    'Ginit ja maustetut viinat', 'Liköörit ja Katkerot', 'kuohuviinit & samppanjat', 'vodkat ja viinat'
];
?>
