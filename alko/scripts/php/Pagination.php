...
// Initialize Alko data model
$alkoData = initModel();

// Handle request to retrieve filters
$filters = handleRequest();

// Generate view based on Alko data and filters, creating a table for products
$alkoProductTable = generateView($alkoData, $filters, 'products');

// Count the total number of rows found in Alko data
$rowsFound = count($alkoData);

// Display header with the number of items found
...
// Update the URL parameters with the new filters using cookies
