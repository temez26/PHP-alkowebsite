<form class="container d-flex justify-content-center align-items-center mt-3 col-12">
    ...
    <div class="form-group m-1">
        <input type="number" class="form-control" name="priceLow" id="priceLow" placeholder="Hinta Min" value="<?php echo isset($_GET['priceLow']) ? htmlspecialchars($_GET['priceLow']) : '' ?>">
    </div>

    <!-- Input for maximum price -->
    <div class="form-group m-1">
        <input type="number" class="form-control" name="priceHigh" id="priceHigh" placeholder="Hinta Max" value="<?php echo isset($_GET['priceHigh']) ? htmlspecialchars($_GET['priceHigh']) : '' ?>">
    </div>

    <!-- Input for minimum energy -->
    <div class="form-group m-1">
        <input type="number" class="form-control" name="energyLow" id="energyLow" placeholder="Energia Min" value="<?php echo isset($_GET['energyLow']) ? htmlspecialchars($_GET['energyLow']) : '' ?>">
    </div>

    <!-- Input for maximum energy -->
    <div class="form-group m-1">
        <input type="number" class="form-control" name="energyHigh" id="energyHigh" placeholder="Energia Max" value="<?php echo isset($_GET['energyHigh']) ? htmlspecialchars($_GET['energyHigh']) : '' ?>">
    </div>
